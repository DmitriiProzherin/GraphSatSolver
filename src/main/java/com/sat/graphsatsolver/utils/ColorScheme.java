...
public class ColorScheme {
    ...
    public static final Color VERTEX_CIRCLE_FILL_DEFAULT = Color.GREY;
    public static final double OPACITY_ACTIVE = 0.99;
    public static final double OPACITY_DISABLED = 0.6;
}
